...
//=============================================================================
void CApp::displayScore(int x, int y, const char* formattedString, int number)
{
    
    sprintf_s(message, formattedString, number); //convert number to string, insert into formatted string

    messageSurface = TTF_RenderText_Solid(ourFont, message, color); //make text an image (an SDL_Surface)
